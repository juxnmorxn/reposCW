    ...
    <div className="bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200 rounded-2xl p-4 shadow-sm mb-6 relative overflow-hidden">
      <div className="flex items-start justify-between gap-3">
        ...
        <button
          ...
          className="text-slate-400 hover:text-slate-600 dark:text-slate-300 p-1 rounded-lg hover:bg-amber-100 transition-colors"
      ...
      <div className="mt-3 space-y-2.5">
        {pendingReportes.map((reporte) => (
          <div
            key={reporte.id}
            className="bg-white dark:bg-slate-900 p-3 rounded-xl border border-amber-200/80 shadow-subtle flex flex-col sm:flex-row sm:items-center justify-between gap-3"
          >
            <div>
              <div className="flex items-center gap-2">
                <span className="font-semibold text-slate-900 dark:text-white">{reporte.nombre_cliente || reporte.folio || 'General'}</span>
              ...
              <p className="text-xs text-slate-600 dark:text-slate-300 mt-0.5 line-clamp-1">
                <span className="font-medium text-slate-700 dark:text-slate-200">Actividad:</span> {reporte.descripcion_actividad || reporte.accion_realizada || 'N/A'}
              </p>
            </div>
            ...
            <div className="flex items-center gap-1.5 shrink-0">
              ...
              <button
                ...
                className="flex-1 sm:flex-initial inline-flex items-center justify-center gap-1 px-2.5 py-1.5 rounded-lg text-xs font-semibold bg-amber-50 dark:bg-amber-900/30 text-amber-700 hover:bg-amber-100 border border-amber-300 transition-colors active:scale-95"
              >
              ...
              <button
                ...
                className="flex-1 sm:flex-initial inline-flex items-center justify-center gap-1 px-2.5 py-1.5 rounded-lg text-xs font-semibold bg-rose-50 dark:bg-rose-900/30 text-rose-700 hover:bg-rose-100 border border-rose-300 transition-colors active:scale-95"
              >
